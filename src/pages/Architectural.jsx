    ...
    <div className="relative h-screen overflow-y-scroll scrollbar-hide">
                  ...
                  <div className="flex">
                    ...
                    <div className="relative w-2/3 h-220 overflow-hidden group">
                      <img
                        className="w-full h-full object-cover object-right transition-transform duration-700 ease-in-out group-hover:scale-110"
                        src="images/architectural2.jpg"
                        alt="Furniture Set"
                      />
