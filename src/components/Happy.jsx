...
const Happy = () => {
  return (
    <div className="bg-[#030303]">
      <div className="container mt-20 mx-auto py-20 px-[110px]">
        <div>
          ...
          <div className="flex">
            <div className="mt-20 grid grid-cols-2 gap-[30px]">
              <div className="w-[357px] h-[292px] mt-3 rounded-xl border border-[#382013] p-8">
                <p className="font-Manrope text-lg font-normal text-white leading-7 backdrop-blur-md mb-5">
              ...
              <div className="w-[357px] h-[292px] mt-3 rounded-xl border border-[#382013] p-8">
                <p className="font-Manrope text-lg font-normal text-white leading-7 backdrop-blur-md mb-5">
                  “I commissioned a custom wood carving from this artist and
                  they exceeded all of my expectations. Their attention to
              ...
              <div className="w-[357px] h-[292px] mt-3 rounded-xl border border-[#382013] p-8">
                <p className="font-Manrope text-lg font-normal text-white leading-7 backdrop-blur-md mb-5">
                  “I received a wood carving as a gift from this artist and it
                  is now one of my most prized possessions. The quality and
