...
const Banner = () => {
  return (
    <div className="bg-linear-to-t from-[rgb(3,3,3)] to-[rgb(44,18,4)] h-screen w-full ">
      <div className="container mx-auto px-[110px]">
        ...
        <div className="text-[#d6d4c880] font-inter text-[15px] uppercase font-medium leading-[25px] tracking-[1px] -rotate-90 -ml-430 -mt-410 duration-[1s]">
          made with{" "}
